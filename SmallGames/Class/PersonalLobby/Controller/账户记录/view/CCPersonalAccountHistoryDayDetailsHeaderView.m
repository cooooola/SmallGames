//
//  CCPersonalAccountHistoryDayDetailsHeaderView.m
//  SmallGames
//
...
@interface CCPersonalAccountHistoryDayDetailsHeaderView ()
@property(nonatomic,strong)UIView *lineView;


@end

@implementation CCPersonalAccountHistoryDayDetailsHeaderView
-(void)initView{
    ...
    [self.timeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.equalTo(@(MCScreenWidth/6-0.5));
    }];
