//
//  CCPersonalAccountHistorySettledViewController.m
//  SmallGames
//
...
@interface CCPersonalAccountHistorySettledViewController ()
...
@implementation CCPersonalAccountHistorySettledViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
            case 0:{
                ...
                model.zhushu = weakSelf.personalAccountHistoryModel.this_day_pk10_c;
                model.jinge = weakSelf.personalAccountHistoryModel.this_day_pk10_l;
                model.yingkui = weakSelf.personalAccountHistoryModel.this_day_pk10_z;
                model.type = @"1";
            }break;
            case 1:{
                model.name = @"幸运飞艇";
                model.time = weakSelf.betTime;
                model.zhushu = weakSelf.personalAccountHistoryModel.this_day_xyft_c;
                model.jinge = weakSelf.personalAccountHistoryModel.this_day_xyft_l;
                model.yingkui = weakSelf.personalAccountHistoryModel.this_day_xyft_z;
                model.type = @"2";
            }break;
            case 2:{
                model.name = @"时时彩";
                model.time = weakSelf.betTime;
                model.zhushu = weakSelf.personalAccountHistoryModel.this_day_ssc_c;
                model.jinge = weakSelf.personalAccountHistoryModel.this_day_ssc_l;
                model.yingkui = weakSelf.personalAccountHistoryModel.this_day_ssc_z;
                model.type = @"3";
            }break;
        default:break;
    }
...
-(void)initData{
    ...
    [CCMineManage MineBetRecordDetailsSettledWithGettime:_betTime completion:^(id resultDictionary, NSError *error) {
...
-(void)setPersonalAccountHistoryModel:(CCPersonalAccountHistoryModel *)personalAccountHistoryModel{
    ...
    historyModel.yingkui = personalAccountHistoryModel.this_day_all_z;
