//
//  CCGameBeijingRacingTrendViewController.m
//  SmallGames
//
...
@interface CCGameBeijingRacingTrendViewController ()
@property(nonatomic,strong)NSMutableArray *dataArray;
@property(nonatomic,strong)CCGameBeijingRacingTrendHeaderView *beijingRacingTrendHeaderView;
@end

@implementation CCGameBeijingRacingTrendViewController
...
-(void)initData{
    ...
    [CCMineManage MineTrendWithGameType:GameTypeBeijingRacing completion:^(id resultDictionary, NSError *error) {
